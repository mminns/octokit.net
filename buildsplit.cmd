...
if NOT "%RunBuild%"=="" (
"tools\FAKE.Core\tools\Fake.exe" "buildsplit.fsx" "target=BuildApp" "buildMode=%BUILDMODE%"
)

"tools\FAKE.Core\tools\Fake.exe" "buildsplit.fsx" "target=%TARGET%" "buildMode=%BUILDMODE%"
